export default function Rating() {
  return (
    <div className="py-6 md:py-10 px-4 lg:px-0">
      ...
      <div className="relative h-48 md:h-64 flex justify-center mb-8">
       
        <div className="relative w-48 h-48 md:w-60 md:h-64">
          
          
          <div className="absolute left-1 bottom-20 md:bottom-26 w-24 h-24 md:w-28 md:h-28 z-10">
          ...
          <div className="absolute left-0 md:left-0 top-32 md:top-38 w-28 h-28 md:w-32 md:h-32">
            <svg className="w-full h-full transform -rotate-90">
